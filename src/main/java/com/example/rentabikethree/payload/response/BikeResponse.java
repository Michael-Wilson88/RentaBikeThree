...
public class BikeResponse {
    ...
    public BikeResponse(long id, String brand, String bikeNumber,
                        String frameNumber, double baseRentalPrice,
                        long rentalDays, double rentalPrice,
                        LocalDate returnDate, boolean isRented) {
        this.id = id;
        this.brand = brand;
